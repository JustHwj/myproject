...
export default () => {
  ...
  const testimonials = [
    {
      imageSrc:
        "https://harlequin-managing-pinniped-424.mypinata.cloud/ipfs/QmQhXgX3RK2vWzLbh4SnYsUgEAAvU41hwhhsgf2a9DcstL",
      quote:
        "In this broken city, the air is filled with electronic trash, danger and opportunity are everywhere, out of control AI, psychosis, gangs, you never know who will come tomorrow, but you're still here.",
 

    },
    {
      imageSrc:
        "https://harlequin-managing-pinniped-424.mypinata.cloud/ipfs/QmWGshXA1egcyrHtcPpnjroR88bUXRMyx8p22czE9MTPqN",
      quote:
        "Coming soon...",
    ...
    {
      imageSrc:
        "https://harlequin-managing-pinniped-424.mypinata.cloud/ipfs/QmZnF2fb5upDBY2by7sK6Nk5tTzQoSqMsaLUUC8YSQPdXG",
      quote:
        "Coming soon...",
    ...
    <Container>
      <Content>
        <HeadingInfoContainer>
          <HeadingTitle>About CyberAIpunk</HeadingTitle>
